...
This project aims to identify the most profitable coffee shop locations and products based on sales data. The findings will help determine the best investment opportunities across various store branches, product categories, and time patterns. We used R for data cleaning, analysis, and visualization.
...
- **Time Limitation**: The entire project had to be completed in under 8 hours.
- **Data Quality Issues**: Missing and malformed time/date values required conversion and validation.
- **Category Inconsistencies**: Manual inspection needed to clean and merge similar product types.
- **Data Volume**: Grouping by multiple variables required optimized code to ensure performance.
- **Time Interpretation**: Transforming string-based time data using `lubridate` took several test iterations.
